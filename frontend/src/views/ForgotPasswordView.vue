<template>
  <AuthLayout>
    <div class="forgot-card">
      ...
      <el-steps :active="activeStep" align-center class="forgot-steps">
        <el-step title="填写邮箱" />
        <el-step title="验证邮箱" />
        <el-step title="重置密码" />
      </el-steps>
      ...
      >
        <div class="step-hint">
          正在为 <span class="hint-email">{{ form.email }}</span> 设置新密码
        </div>
